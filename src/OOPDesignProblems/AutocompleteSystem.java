...
class AutocompleteSystem {
    ...
    public static void main(String[] args){
        ...
        System.out.println(Arrays.asList(as.input('i'))); //["i love you","island","i love leetcode"]
        System.out.println(Arrays.asList(as.input(' '))); //["i love you","i love leetcode"]
        System.out.println(Arrays.asList(as.input('a'))); //[]
        System.out.println(Arrays.asList(as.input('#'))); //[]
    }
}
